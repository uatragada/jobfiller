...
interface NavItemBaseProps {
    ...
    /** Stable selector used by JobFiller browser tests. */
    testId?: string;
    /** Content to display. */
    children?: ReactNode;
}

export const NavItemBase = ({ current, type, badge, href, icon: Icon, children, truncate = true, onClick, testId }: NavItemBaseProps) => {
    ...
    if (type === "collapsible") {
        return (
            <summary data-testid={testId} className={cx("p-2", styles.root, current && styles.rootSelected)} onClick={onClick}>
                {iconElement}
